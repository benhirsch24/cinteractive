...
goog.provide("clojureinterp.util");
goog.require("cljs.core");
clojureinterp.util.forM = function() {
  var forM = null;
  var forM__3 = function(f, as, state) {
    while(true) {
      var G__2855 = f;
      var G__2856 = as;
      var G__2857 = cljs.core.PersistentVector.EMPTY;
      f = G__2855;
      as = G__2856;
      state = G__2857;
      continue;
  ...
  var forM__4 = function(f, as, state, values) {
    while(true) {
      if(cljs.core.empty_QMARK_.call(null, as)) {
        return cljs.core.ObjMap.fromObject(["\ufdd0'values", "\ufdd0'state"], {"\ufdd0'values":values, "\ufdd0'state":state})
      }else {
        var map__2854 = f.call(null, cljs.core.first.call(null, as));
        var map__2854__$1 = cljs.core.seq_QMARK_.call(null, map__2854) ? cljs.core.apply.call(null, cljs.core.hash_map, map__2854) : map__2854;
        var v = cljs.core._lookup.call(null, map__2854__$1, "\ufdd0'val", null);
        var newstate = cljs.core._lookup.call(null, map__2854__$1, "\ufdd0'state", null);
        var G__2858 = f;
        var G__2859 = cljs.core.rest.call(null, as);
        var G__2860 = newstate;
        var G__2861 = cljs.core.conj.call(null, values, v);
        f = G__2858;
        as = G__2859;
        state = G__2860;
        values = G__2861;
  ...
  forM = function(f, as, state, values) {
    switch(arguments.length) {
      case 3:
        return forM__3.call(this, f, as, state);
      case 4:
        return forM__4.call(this, f, as, state, values)
    }
    throw new Error("Invalid arity: " + arguments.length);
  };
  forM.cljs$lang$arity$3 = forM__3;
  forM.cljs$lang$arity$4 = forM__4;
  return forM
}();
clojureinterp.util.addToEnv = function addToEnv(vname, node, state) {
  var map__2863 = state;
  var map__2863__$1 = cljs.core.seq_QMARK_.call(null, map__2863) ? cljs.core.apply.call(null, cljs.core.hash_map, map__2863) : map__2863;
  var heap = cljs.core._lookup.call(null, map__2863__$1, "\ufdd0'heap", null);
  var stack = cljs.core._lookup.call(null, map__2863__$1, "\ufdd0'stack", null);
  var nxt = cljs.core._lookup.call(null, map__2863__$1, "\ufdd0'next", null);
  var newstack = cljs.core.conj.call(null, cljs.core.assoc.call(null, cljs.core.first.call(null, stack), vname, nxt), cljs.core.rest.call(null, stack));
  var newheap = cljs.core.assoc.call(null, heap, nxt, node);
  return cljs.core.assoc.call(null, state, "\ufdd0'stack", newstack, "\ufdd0'heap", newheap, "\ufdd0'next", nxt + 1)
};
clojureinterp.util.unquotify = function unquotify(name) {
  var fquote = function(s) {
    if(cljs.core._EQ_.call(null, '"', cljs.core.first.call(null, s))) {
      return cljs.core.rest.call(null, s)
    }else {
      return s
    }
  };
  var lquote = function(s) {
  ...
  return cljs.core.apply.call(null, cljs.core.str, cljs.core.comp.call(null, fquote, lquote).call(null, name))
};
clojureinterp.util.evalType = function evalType(specs) {
  return cljs.core.reduce.call(null, function(specifier, acc) {
    var spec = (new cljs.core.Keyword("\ufdd0'node")).call(null, (new cljs.core.Keyword("\ufdd0'spec")).call(null, specifier));
    return cljs.core.conj.call(null, acc, spec)
  }, cljs.core.PersistentVector.EMPTY, specs)
};
clojureinterp.util.initial_value = function initial_value(decl, tipe) {
  return 0
};
clojureinterp.util.evalDecl = function evalDecl(tipe, decl, state) {
  var decl_name = clojureinterp.util.unquotify.call(null, (new cljs.core.Keyword("\ufdd0'name")).call(null, (new cljs.core.Keyword("\ufdd0'declarator")).call(null, decl)));
  var init_val = clojureinterp.util.initial_value.call(null, decl, tipe);
  return cljs.core.ObjMap.fromObject(["\ufdd0'val", "\ufdd0'state"], {"\ufdd0'val":null, "\ufdd0'state":clojureinterp.util.addToEnv.call(null, decl_name, init_val, state)})
};
clojureinterp.util.lookup_fn_addr = function lookup_fn_addr(fun, state) {
  var globals = cljs.core.last.call(null, (new cljs.core.Keyword("\ufdd0'stack")).call(null, state));
  return cljs.core._lookup.call(null, fun, globals, null)
};
goog.provide("clojureinterp.eval");
goog.require("cljs.core");
goog.provide("clojureinterp.stepper");
goog.require("cljs.core");
goog.require("clojureinterp.eval");
goog.require("clojureinterp.util");
clojureinterp.stepper.init_state = function init_state(ast) {
  var decls = (new cljs.core.Keyword("\ufdd0'decls")).call(null, ast);
  var map__2865 = clojureinterp.stepper.forM.call(null, decls, clojureinterp.stepper.compileDecl, cljs.core.ObjMap.EMPTY);
  var map__2865__$1 = cljs.core.seq_QMARK_.call(null, map__2865) ? cljs.core.apply.call(null, cljs.core.hash_map, map__2865) : map__2865;
  var s = cljs.core._lookup.call(null, map__2865__$1, "\ufdd0'state", null);
  return s
};
clojureinterp.stepper.compile = function compile(ast) {
  var state = clojureinterp.stepper.init_state.call(null, ast);
  var main_addr = clojureinterp.stepper.lookup_fn_addr.call(null, "main", state);
  return cljs.core.ObjMap.fromObject(["\ufdd0'control", "\ufdd0'stack", "\ufdd0'heap", "\ufdd0'next", "\ufdd0'ret", "\ufdd0'dump", "\ufdd0'kont"], {"\ufdd0'control":main_addr, "\ufdd0'stack":(new cljs.core.Keyword("\ufdd0'stack")).call(null, state), "\ufdd0'heap":(new cljs.core.Keyword("\ufdd0'heap")).call(null, state), "\ufdd0'next":(new cljs.core.Keyword("\ufdd0'next")).call(null, state), "\ufdd0'ret":null, "\ufdd0'dump":cljs.core.PersistentVector.EMPTY, "\ufdd0'kont":function(ui) {
    return ui.html("Main on the stack")
  }})
};
goog.exportSymbol("clojureinterp.stepper.compile", clojureinterp.stepper.compile);
clojureinterp.stepper.compileDecl = function compileDecl(node, state) {
  var node_name = (new cljs.core.Keyword("\ufdd0'node")).call(null, node);
  if(cljs.core._EQ_.call(null, "CFunDef", node_name)) {
    var fun_name = U.unquotify.call(null, (new cljs.core.Keyword("\ufdd0'name")).call(null, (new cljs.core.Keyword("\ufdd0'fun_def")).call(null, node)));
    return cljs.core.ObjMap.fromObject(["\ufdd0'val", "\ufdd0'state"], {"\ufdd0'val":null, "\ufdd0'state":U.addToEnv.call(null, fun_name, node, state)})
  }else {
    if(cljs.core._EQ_.call(null, "CDecl", node_name)) {
      var tipe = U.evalType.call(null, (new cljs.core.Keyword("\ufdd0'specifiers")).call(null, node));
      var map__2867 = clojureinterp.stepper.forM.call(null, cljs.core.partial.call(null, U.evalDecl, tipe), (new cljs.core.Keyword("\ufdd0'declarations")).call(null, node), state);
      var map__2867__$1 = cljs.core.seq_QMARK_.call(null, map__2867) ? cljs.core.apply.call(null, cljs.core.hash_map, map__2867) : map__2867;
      var newstate = cljs.core._lookup.call(null, map__2867__$1, "\ufdd0'state", null);
      return cljs.core.ObjMap.fromObject(["\ufdd0'val", "\ufdd0'state"], {"\ufdd0'val":null, "\ufdd0'state":newstate})
    }else {
      return null
    }
  }
